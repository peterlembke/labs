...
/var/www/public_html/svg-maps2/import.php:373:
array (size=6)
  'answer' => string 'true' (length=4)
  'message' => string 'SUCCESS, importing the file' (length=27)
  'country_code' => string 'DE' (length=2)
  'db_name' => string 'data/de.sqlite' (length=14)
  'rows_stored' => int 8304
  'rows_duplicate' => int 8173